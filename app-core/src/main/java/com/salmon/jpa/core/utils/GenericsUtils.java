...
public class GenericsUtils {
	/**  
     * 通过反射,获得指定类的父类的泛型参数的实际类型. 如UserServiceBean extends DaoSupport<User>  
	...
	public static Class getSuperClassGenericType(Class clazz, int index) {
        ...
        //返回表示此类型实际类型参数的Type对象的数组,数组里放的都是对应类型的Class, 如UserServiceBean extends DaoSupport<User,Contact>就返回User和Contact类型   
	...
	/**  
     * 通过反射,获得Field泛型参数的实际类型. 如: public Map<String, User> names;
     * @param  field 字段
     * @return 泛型参数的实际类型, 如果没有实现ParameterizedType接口，即不支持泛型，所以直接返回<code>Object.class</code>
     */ 
    @SuppressWarnings("rawtypes")
